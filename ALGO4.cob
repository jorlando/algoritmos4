	...
	01 LINEA                      PIC X(80).
       ...
       INICIALIZAR.
		...
		ORDENAR-TABLA-ESTADOS.
			...
			PERFORM UNTIL J > MAX-EST
				IF (TAB-ESTADOS-ELM (I) >
				TAB-ESTADOS-ELM (J))
					MOVE TAB-ESTADOS-ELM (I) TO AUX
					MOVE TAB-ESTADOS-ELM (J)
					TO TAB-ESTADOS-ELM (I)
	   ...
	   IMPRIMIR-BAJA.
		...
		MOSTRAR-ESTADISTICAS.
			...
			MOVE 1 TO IND2.			
			PERFORM CICLO-ESTADISTICA-1 
				UNTIL IND2 > CONT-ANIO.
        ...
        POS-CONSORN3.
	    	...
	    	ALTA-MAESTRO.
               ...
               IF CON-MENOR-CUIT-CONS NOT EQUAL 
                                   TO CTA-CUIT-CONS
               ...
               MOVE CON-MENOR-NOMBRE-CONSORCIO 
