	...
	01 LINEA                      PIC X(80).
		...
		01 WS-TAB-ESTADOS.
			03 WS-TAB-ESTADOS-ELM OCCURS 30 TIMES 
				INDEXED BY IND.
				05 WS-TAB-ESTADOS-ESTADO PIC 9(02).
				05 WS-TAB-ESTADOS-DESCRIP PIC X(15).
	   ...
	   CARGAR-ESTADO.
		 MOVE EST TO WS-TAB-ESTADOS-ELM (WS-CONT-ESTADOS).
		 PERFORM LEO-ESTADO.
