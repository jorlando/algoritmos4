	...
	01 WS_TABLA_ESTADOS.
		03 WS_TABLA_ESTADOS_ELEMENTO OCCURS 30 TIMES INDEXED BY IND.
	...
	GEN-TABLA-ESTADOS.
		...
		PERFORM LEO-ESTADO.
		PERFORM CARGAR-ESTADO VARYING WS_CONT_ESTADOS
			FROM 1 BY 1 UNTIL FS_EST = 10 OR WS_CONT_ESTADOS > 30.		
	...
	LEO-ESTADO.
		...
		READ ESTADOS.
		IF FS_EST NOT = ZERO
			DISPLAY "Error al leer ESTADOS - FS:" FS_EST
			STOP RUN.
		
	CARGAR-ESTADO.
		MOVE EST TO WS_TABLA_ESTADOS_ELEMENTO (WS_CONT_ESTADOS).
		PERFORM LEO-ESTADO.
	...
	OBTENER-ESTADO.
		...
		WHEN WS_TABLA_ESTADOS_ESTADO(IND) = WS_CONS_MENOR-ESTADO
